  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-5xl px-6 md:px-8 py-10">
        <PageHeader title="My orders" subtitle={`${orders.length} orders total`} />
            ...
            {orders.map((o) => (
              <li key={o.orderId}>
                <Link
                  ...
                  className="block rounded-2xl border border-line bg-space-850 p-5 hover:border-brand-yellow/40 transition"
                >
                  <div className="flex items-start justify-between gap-4 mb-3">
                    ...
                    <div className="text-right">
                      ...
                      <div className="mt-2 font-display text-xl font-extrabold text-brand-yellow">
                  ...
                  <div className="flex items-center gap-2 overflow-hidden">
                    {o.items.slice(0, 4).map((it) => (
                      <div key={it.orderItemId} className="relative h-14 w-14 rounded-xl bg-space-900 overflow-hidden shrink-0 border border-line">
