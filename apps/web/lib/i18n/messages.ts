...
export const MESSAGES: Record<Locale, Messages> = {
  en: {
    ...
    "cart.coupon.placeholder": "Try WELCOME10 — 10% off platform-wide",
    "cart.coupon.notFound": "Coupon not found or inactive. Try WELCOME10 for 10% off.",
  ...
  th: {
    ...
    "cart.coupon.placeholder": "ลอง WELCOME10 — ลด 10% ทั้งร้าน",
    "cart.coupon.notFound": "ไม่พบโค้ดหรือโค้ดยังไม่เปิดใช้งาน ลอง WELCOME10 เพื่อรับส่วนลด 10%",
